var regLoading = / ?loading/g, md = markdownit({
...
(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        (function(window, document, $, reqwest, Router, markdownit) {
            var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), Content = require("./store-dist"), DOMRef = require("./domStore-dist"), app = {
            ...
            function render() {
                return h("#wrapper", [ h("#content.fullPage", [ h("#contentWrap", [ h("#output") ]) ]) ]);
            }
        ...
        "./domStore-dist": 2,
        "./store-dist": 39,
        "virtual-dom/create-element": 6,
        "virtual-dom/diff": 7,
        "virtual-dom/h": 8,
        "virtual-dom/patch": 16
    } ],
    ...
    4: [ function(require, module, exports) {
        define("manage", [ "" ], function() {
            "use strict";
            var app = require("./content3a"), h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), DOMRef = require("./domStore"), Content = require("./store"), regFullPage = / ?fullPage/g, regCheatSheet = / ?cheatSheet/g, regNoChange = / ?nochange/g, manage = {};
            ...
            manage.modalRender = function(options, callback) {
                ...
                return h(".modalOverlay", {
                    ...
                    onclick: cancel
                }), h(".modal", [ h(".header", [ h("h2", [ String(options.title || "") ]) ]), h("label", [ String(options.text || ""), options.type === "new" && h("input.modalInput", {
                    type: "text",
                    tabIndex: 0,
                    autofocus: "",
                    onkeyup: ok
                }) || null, options.type === "new" && h("select.menuItems", {
                    tabIndex: 1,
                    onkeyup: ok
                }, [ app.menuItems || null ]) || null ]), h(".modalButtons", [ h(".okButton.btn", {
                    tabIndex: 2,
                    onclick: ok,
                    role: "button"
            ...
            manage.toggleEditor = function() {
                ...
                app.domRefs.$contentWrap.velocity({
                    opacity: 0
                }, {
                    duration: 50,
                    complete: function() {
            ...
            manage.renderEditor = function() {
                return h("#wrapper", [ h("#content.fullPage", [ h("#buttons", [ h("input#titleField", {
                    onkeyup: updateTitle,
                    value: String(app.currentContent.title || ""),
                    type: "text"
                }), h("#toggleButton.btn", {
                    onclick: toggleEditor,
                    role: "button"
                }, [ h("span", [ "Toggle Editor" ]) ]), h("#cheatSheetButton.btn", {
                    onclick: toggleCheatSheet,
                    role: "button"
                }, [ h("span", [ "Cheat Sheet" ]) ]), h("#deleteButton.btn", {
                    onclick: deletePage,
                    role: "button"
                }, [ h("span", [ "Delete" ]) ]), h("#createButton.btn", {
                    onclick: createPage,
                    role: "button"
                }, [ h("span", [ "New" ]) ]), h("#saveButton.btn", {
                    onclick: savePage,
                    role: "button"
                }, [ h("span", [ "Save" ]) ]) ]), h("#cheatSheet", [ "This will be a cheat-sheet for markdown" ]), h("#contentWrap", [ h("#input", [ h("textarea#textarea", [ String(app.currentContent.text || "") ]) ]), h("#output") ]) ]) ]);
            };
            return manage;
        });
    }, {
    ...
    8: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 25
    } ],
    ...
    18: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 27,
        "../vnode/is-vnode.js": 30,
        "../vnode/is-vtext.js": 31,
        "../vnode/is-widget.js": 32,
        "./apply-properties": 17,
        "global/document": 13
    } ],
