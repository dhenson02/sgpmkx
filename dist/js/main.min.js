...
(function e(t, n, r) {
    ...
    84: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 101
    } ],
    ...
    94: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 103,
        "../vnode/is-vnode.js": 106,
        "../vnode/is-vtext.js": 107,
        "../vnode/is-widget.js": 108,
        "./apply-properties": 93,
        "global/document": 89
    } ],
    ...
    115: [ function(require, module, exports) {
        var events = require("./store").events, pages = require("./store").pages, reqwest = require("reqwest"), sweetAlert = require("sweetalert"), misc = require("./helpers"), inTransition = misc.inTransition, baseURL = _spPageContextInfo.webAbsoluteUrl, sitePath = baseURL + "/_api/lists/getByTitle('Content')", digest = document.getElementById("__REQUESTDIGEST").value;
    ...
    118: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), horsey = require("horsey"), misc = require("./helpers"), inTransition = misc.inTransition, codeMirror = misc.codeMirror, data = require("./data"), sitePath = data.sitePath, digest = data.digest, pages = require("./store").pages, events = require("./store").events, current = pages.current, DOM = require("./domStore"), dirtyDOM = null, rootNode = null, navDOM = null, renderNav = require("./nav"), renderTabs = require("./tabs"), tabsDOM = renderTabs([ {
            title: "Overview",
            icon: "home"
        } ], {
            style: {
        ...
        function renderEditor(navDOM, tabsDOM, title, text) {
            return h("#ph-wrapper", [ h("#ph-search-wrap", [ h("label", {
                ...
                placeHolder: "Search...!"
            }) ]), h("#ph-side-nav", [ navDOM ]), h("#ph-content.fullPage", [ h("#ph-buttons", [ h("input.ph-toggle-editor", {
                type: "checkbox",
                ...
                type: "button"
            }, [ "Markdown help" ]), h("a#saveButton.ph-btn", {
                href: "#",
            ...
            }, [ "Save" ]) ]), tabsDOM, h("h1#ph-title", [ String(title || "") ]), h("#cheatSheet", {
                style: {
                    display: "none"
                }
        ...
        reqwest: 80,
        sweetalert: 81,
        "virtual-dom/create-element": 82,
        "virtual-dom/diff": 83,
        "virtual-dom/h": 84,
        "virtual-dom/patch": 92
    } ],
    119: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), codeMirror = require("./helpers").codeMirror, pages = require("./store").pages, events = require("./data").events;
        ...
        function renderSection(section) {
            ...
            if (codeMirror) {
                links[++i] = h("a#createButton.ph-btn", {
                    href: "#",
                    onclick: function(event) {
                        event = event || window.event;
                        if (event.preventDefault) event.preventDefault(); else event.returnValue = false;
        ...
        function renderNav(sections) {
            ...
            links.push(h("a#createButton.ph-btn", {
                href: "#",
                onclick: function(event) {
                    event = event || window.event;
                    if (event.preventDefault) event.preventDefault(); else event.returnValue = false;
    ...
    121: [ function(require, module, exports) {
        ...
        function renderTabs(tabs, style, launch) {
            var group = [], i = 0, count = tabs.length, initial = ".tab-current";
            for (;i < count; ++i) {
