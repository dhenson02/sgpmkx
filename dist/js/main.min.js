(function e(t, n, r) {
    ...
    2: [ function(require, module, exports) {
        ...
        "../internal/arrayReduce": 3,
        "../internal/baseEach": 6,
        "../internal/createReduce": 23
    } ],
    ...
    49: [ function(require, module, exports) {
        ...
        "../internal/baseProperty": 15,
        "../internal/basePropertyDeep": 16,
        "../internal/isKey": 32
    } ],
...
(function e(t, n, r) {
    ...
    16: [ function(require, module, exports) {
        ...
        "./getSelectionNullOp": 17,
        "./getSelectionRaw": 18,
        "./getSelectionSynthetic": 19,
        "./isHost": 20
    } ],
    17: [ function(require, module, exports) {
        "use strict";
    ...
    69: [ function(require, module, exports) {
        ...
        "../internal/isArrayLike": 60,
        "../internal/isObjectLike": 64
    } ],
    70: [ function(require, module, exports) {
        ...
        "../internal/getNative": 59,
        "../internal/isLength": 63,
        "../internal/isObjectLike": 64
    } ],
    ...
    79: [ function(require, module, exports) {
        ...
        "../internal/baseProperty": 47,
        "../internal/basePropertyDeep": 48,
        "../internal/isKey": 62
    } ],
    ...
    83: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 100
    } ],
    ...
    93: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 102,
        "../vnode/is-vnode.js": 105,
        "../vnode/is-vtext.js": 106,
        "../vnode/is-widget.js": 107,
        "./apply-properties": 92,
        "global/document": 88
    } ],
    ...
    114: [ function(require, module, exports) {
        var misc = require("./helpers"), codeMirror = misc.codeMirror, pages = require("./store").pages, render = require("./page").render, renderEditor = require("./page").editor, renderNav = require("./nav"), renderTabs = require("./tabs");
        function DOM() {
    ...
    116: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), horsey = require("horsey"), misc = require("./helpers"), inTransition = misc.inTransition, codeMirror = misc.codeMirror, pages = require("./store").pages, events = require("./store").events, current = pages.current, DOM = require("./domStore"), router = Router({
            "/": {
                on: function() {
        ...
        "virtual-dom/diff": 82,
        "virtual-dom/h": 83,
        "virtual-dom/patch": 91
    } ],
    117: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), codeMirror = require("./helpers").codeMirror, pages = require("./store").pages, events = require("./store").events, map = require("lodash/collection/map");
        ...
        function renderNav() {
            ...
            links.push(h("a.ph-btn.ph-create", {
                href: "#",
                onclick: function(event) {
                    event = event || window.event;
                    if (event.preventDefault) event.preventDefault(); else event.returnValue = false;
        ...
        "./helpers": 115,
        "./store": 119,
        "lodash/collection/map": 32,
        "virtual-dom/h": 83
    } ],
    118: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), pages = require("./store").pages, events = require("./store").events;
        function render(navDOM, tabsDOM) {
            return h("#ph-wrapper", [ h("#ph-search-wrap", [ h("label", {
                htmlFor: "ph-search"
            }, [ "Search (for now use up and down keys to select, then press enter):\n" ]), h("input#ph-search", {
                placeHolder: "Search...!"
            }) ]), h("#ph-side-nav", [ navDOM ]), h("#ph-content.fullPage", [ tabsDOM, h("h1#ph-title", [ String(title || "") ]), h("#ph-contentWrap", [ h("#ph-output") ]) ]) ]);
        }
        function editor(navDOM, tabsDOM, DOM) {
            return h("#ph-wrapper", [ h("#ph-search-wrap", [ h("label", [ "Search (for now use up and down keys to select, then press enter):\n", h("input#ph-search", {
                type: "text",
                name: "ph-search",
                placeholder: "Search...!"
            }) ]) ]), h("#ph-side-nav", [ navDOM ]), h("#ph-content.fullPage", [ h("#ph-buttons", [ h("label.ph-toggle-label", [ h("input.ph-toggle-editor", {
                type: "checkbox",
                name: "ph-toggle",
            ...
            }, [ "Editor" ]) ]), h("div.clearfix"), h("a.ph-btn.ph-cheatsheet", {
                href: "#",
                onclick: function(event) {
                    event = event || window.event;
                    if (event.preventDefault) event.preventDefault(); else event.returnValue = false;
            ...
            }, [ "Markdown help" ]), h("a.ph-btn.ph-save", {
                href: "#",
                onclick: function(event) {
                    event = event || window.event;
                    if (event.preventDefault) event.preventDefault(); else event.returnValue = false;
            ...
            }, [ "Save" ]) ]), tabsDOM, h("h1#ph-title", [ String(pages.current.title || "") ]), h("#cheatSheet", {
                style: {
                    display: "none"
                }
            }, [ "This will be a cheat-sheet for markdown" ]), h("#ph-contentWrap", [ h("#ph-input", [ h("textarea#ph-textarea", [ String(pages.current.text || "") ]) ]), h("#ph-output") ]) ]) ]);
        }
        module.exports = {
            render: render,
            editor: editor
    ...
    119: [ function(require, module, exports) {
        ...
        Pages.prototype.init = function(data) {
            ...
            this.titles = [];
            for (;i < count; ++i) {
                var page = this[urls[i]], isPage = false, level, name = page.rabbitHole || page.Page || page.Program;
                this.titles[i] = {
