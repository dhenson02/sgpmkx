(function e(t, n, r) {
    ...
    76: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 93
    } ],
    ...
    86: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 95,
        "../vnode/is-vnode.js": 98,
        "../vnode/is-vtext.js": 99,
        "../vnode/is-widget.js": 100,
        "./apply-properties": 85,
        "global/document": 81
    } ],
    ...
    107: [ function(require, module, exports) {
        var misc = require("./helpers"), codeMirror = misc.codeMirror, store = require("./store"), pages = store.pages, events = store.events, render = require("./page").render, renderEditor = require("./page").editor, renderNav = require("./nav"), renderTabs = require("./tabs");
        function DOM() {
    ...
    109: [ function(require, module, exports) {
        ...
        "virtual-dom/diff": 75,
        "virtual-dom/h": 76,
        "virtual-dom/patch": 84
    } ],
    110: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), codeMirror = require("./helpers").codeMirror, map = require("lodash/collection/map"), store = require("./store"), pages = store.pages, events = store.events;
    ...
    111: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), store = require("./store"), pages = store.pages, events = store.events;
    ...
    113: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), store = require("./store"), pages = store.pages, events = store.events, map = require("lodash/collection/map"), tabs = [ {
            title: "Overview",
            icon: "home"
        }, {
            title: "Policy",
