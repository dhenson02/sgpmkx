...
(function e(t, n, r) {
    ...
    115: [ function(require, module, exports) {
        var events = require("./store").events, pages = require("./store").pages, baseURL = _spPageContextInfo.webAbsoluteUrl, sitePath = baseURL + "/_api/lists/getByTitle('Content')", digest = document.getElementById("__REQUESTDIGEST").value, data = window.__PHDATA__, data_ = window.__PHDATA___;
    ...
    118: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), horsey = require("horsey"), misc = require("./helpers"), codeMirror = misc.codeMirror, data = require("./data"), sitePath = "", digest = data.digest, pages = require("./store").pages, events = require("./store").events, current = pages.current, DOMRef = require("./domStore").DOMRef, domRefs = new DOMRef(), dirtyDOM = null, rootNode = null, navDOM = null, renderNav = require("./nav"), renderTabs = require("./tabs"), tabsDOM = renderTabs([ {
            title: "Overview",
            icon: "home"
        } ], {
            style: {
        ...
        function render(navDOM, tabsDOM, title) {
            return h("#ph-wrapper", [ h("#ph-search-wrap", [ h("input#ph-search") ]), h("#ph-side-nav", [ navDOM ]), h("#ph-content.fullPage", [ tabsDOM, h("h1#ph-title", [ String(title || "") ]), h("#ph-contentWrap", [ h("#ph-output") ]) ]) ]);
        }
        function renderEditor(navDOM, tabsDOM, title, text) {
            return h("#ph-wrapper", [ h("#ph-search-wrap", [ h("input#ph-search") ]), h("#ph-side-nav", [ navDOM ]), h("#ph-content.fullPage", [ h("#ph-buttons", [ h("button#toggleButton.ph-btn", {
                onclick: editPage,
                style: {
                    display: "none"
                }
