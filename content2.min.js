var regLoading = / ?loading/g, regFullPage = / ?fullPage/g, regCheatSheet = / ?cheatSheet/g, regNoChange = / ?nochange/g, md = markdownit({
...
(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        (function(window, document, $, reqwest, Router, markdownit) {
            var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), Content = require("./store"), DOMRef = require("./domStore"), app = {
            ...
            function render(target, params) {
                var node = h("#wrapper", [ h("#content.fullPage", [ h("#modalOverlay"), h("#contentWrap", [ h("#output") ]) ]) ]);
                if (target === "editor") {
                    node = h("#wrapper", [ h("#content.fullPage", [ h("#buttons", [ h("input#titleField", {
                        onkeyup: updateTitle,
                ...
                if (target === "modal") {
                    node = h("#modalOverlay", [ h(".modalBg", {
                        onclick: handleCancel
                    }), h(".modal", [ h(".header", [ h("h2", [ String(params.title) ]) ]), h("label", [ String(params.text), params.type === "new" && h("input#modalInput", {
                        type: "text"
                    }) || null, params.type === "new" && h("select#menuItems", [ app.menuItems ]) || null ]), h(".modalButtons", [ h(".okButton.btn", {
                        onclick: handleOk
                    }, [ h("span", [ String(params.okText) ]) ]), params.showCancelButton && h(".cancelButton.btn", {
                        onclick: handleCancel
                    }, [ h("span", [ "Nope." ]) ]) || null ]) ]) ]);
                }
                return node;
            ...
            function newModal(options, callback) {
                ...
                app.domRefs.set();
                $(app.domRefs.modalOverlay).velocity({
                    opacity: 1
                }, {
                    duration: 75,
                    display: "block"
            ...
            function resetPage() {
                var wrap, refreshDOM, modalRefreshDOM, modalPatches, patches;
    ...
    6: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 23
    } ],
