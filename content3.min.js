    ...
    1: [ function(require, module, exports) {
        (function(window, document, $, reqwest, Router, markdownit) {
            ...
            function render(target) {
                var node = h("#wrapper", [ h("#content.fullPage", [ h("#contentWrap", [ h("#output") ]) ]) ]);
                if (target === "editor") {
                    node = h("#wrapper", [ h("#content.fullPage", [ h("#buttons", [ h("#toggleButton.btn", {
                        ...
                        onclick: savePage,
                        role: "button"
                    }, [ h("span", [ "Save" ]) ]), h("input#titleField", {
                        onkeyup: updateTitle,
