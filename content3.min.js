(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        (function(window, document, $, reqwest, Router, markdownit) {
            ...
            var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), util = require("./helpers"), Content = require("./store"), DOMRef = require("./domStore"), app = {
            ...
            function renderEditor() {
                return h("#wrapper", [ h("#content.fullPage", [ h("#buttons", [ h("#toggleButton.btn", {
                    ...
                    onclick: createPage,
                    role: "button"
                }, [ h("span", [ "New" ]) ]), h("#deleteButton.btn", {
                    onclick: deletePage,
                    role: "button"
                }, [ h("span", [ "Delete" ]) ]), h("label#titleFieldLabel", [ "Page title: ", h("input#titleField", {
                    onkeyup: updateTitle,
                    value: String(app.currentContent.title || ""),
                    type: "text"
                }) ]) ]), h("#cheatSheet", [ "This will be a cheat-sheet for markdown" ]), h("#contentWrap", [ h("#input", [ h("textarea#textarea", [ String(app.currentContent.text || "") ]) ]), h("#output") ]) ]) ]);
            }
                ...
                if (app.currentContent.text === app.currentContent.originalText && app.currentContent.title === app.currentContent.originalTitle) {
                    ...
                    app.domRefs.buttons.tempSaveText = setTimeout(function() {
                        try {
                            ...
                            console.log(e, self, self.childNodes[0]);
                        }
            ...
            function freshModal(options, callback) {
                ...
                return h(".modalOverlay", {
                    ...
                    onchange: change,
                    onkeyup: ok
                }) || null ])), options.selectLabel && h("label", options.selectLabel.concat([ options.type === "new" && h("select#menuItems", {
                    tabIndex: 1,
                    onkeyup: ok,
                    onchange: change
                }, app.menuItems || null) || null ])), h("blockquote#newPath", options.path), h(".modalButtons", [ h(".okButton.btn", {
                    tabIndex: 2,
                    onclick: ok,
                    role: "button"
            ...
            function getList() {
                ...
                reqwest({
                    ...
                    success: function(data) {
                        var results = data.d.results, pages = {}, fhm = [], comm = [], i = 0, count = results.length, page;
                        for (;i < count; ++i) {
                            page = results[i];
                        ...
                        app.menuItems = [ h("optgroup", {
                            label: "Force Health Management"
                        }, fhm), h("optgroup", {
        ...
        "./helpers": 3,
        "./store": 38,
        "virtual-dom/create-element": 5,
        "virtual-dom/diff": 6,
        "virtual-dom/h": 7,
        "virtual-dom/patch": 15
    } ],
    ...
    7: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 24
    } ],
    ...
    17: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 26,
        "../vnode/is-vnode.js": 29,
        "../vnode/is-vtext.js": 30,
        "../vnode/is-widget.js": 31,
        "./apply-properties": 16,
        "global/document": 12
    } ],
...
//# sourceMappingURL=content3.min.js.map