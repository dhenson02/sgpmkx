(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        var comm = document.getElementById("nav-comm"), fhm = document.getElementById("nav-fhm"), reqwest = require("reqwest"), fhmLinks = "", commLinks = "";
        ...
        reqwest({
            ...
            success: function(data) {
                var results = data.d.results, i = 0, count = results.length, page;
                for (;i < count; ++i) {
                    page = results[i];
