(function e(t, n, r) {
    ...
    3: [ function(require, module, exports) {
        ...
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), util = require("./helpers"), Content = require("./store"), DOMRef = require("./domStore"), renderNav = require("./nav"), renderTabs = require("./tabs"), baseURL = _spPageContextInfo.webAbsoluteUrl, sitePath = baseURL + "/_api/lists/getByTitle('Content')", digest = document.getElementById("__REQUESTDIGEST").value, pages = {}, currentContent = new Content(), domRefs = new DOMRef(), dirtyDOM = null, rootNode = null, navDOM = null, tabsDOM = null, router = null, inTransition = {};
        ...
        function render(navDOM, tabsDOM) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ h("#contentWrap", [ h("#output"), tabsDOM ]) ]) ]);
        }
        function renderEditor(navDOM, tabsDOM, title, text) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ h("#buttons", [ h("button#toggleButton.btn", {
                ...
                value: String(title || ""),
                type: "text"
            }) ]), h("textarea#textarea", [ String(text || "") ]) ]), h("#output"), tabsDOM ]) ]) ]);
        }
        ...
        function savePage(event) {
            ...
            if (currentContent.text === currentContent._text && currentContent.title === currentContent._title) {
        ...
        function pageSetup() {
            ...
            try {
                rootNode.querySelector("#navWrap a[href='" + window.location.hash + "']").className += " active";
            } catch (e) {
                console.log(e);
            }
            try {
        ...
        function getList() {
            reqwest({
                ...
                success: function(data) {
                    var results = data.d.results, urls = [], fhmLinks = [], commLinks = [], i = 0, count = results.length, page;
                    for (;i < count; ++i) {
                    ...
                    for (i = 0; i < count; ++i) {
                        ...
                        if (/^#\/fhm\//i.test(path)) {
                            if (!/^#\/fhm\/(\w+)$/i.test(path)) {
                                fhmLinks.push(renderLink(path, page.Title, "li.sub-cat", {
                                    style: {
                                        display: "none"
                                    }
                                }, null));
                            } else {
                                fhmLinks.push(renderLink(path, page.Title, "li", null, h("hr")));
                            }
                        }
                        if (/^#\/comm\//i.test(path)) {
                            if (!/^#\/comm\/(\w+)$/i.test(path)) {
                                commLinks.push(renderLink(path, page.Title, "li.sub-cat", {
                                    style: {
                                        display: "none"
                                    }
                                }, null));
                            } else {
                                commLinks.push(renderLink(path, page.Title, "li", null, h("hr")));
                            }
                        }
        ...
        function init(path) {
            ...
            reqwest({
                ...
                success: function(data) {
                    ...
                    var tabsStyle = currentContent.program !== "" && currentContent.program !== "Home" ? {} : {
                        style: {
                            display: "none"
                        }
                    };
        ...
        reqwest: 14,
        sweetalert: 15,
        "virtual-dom/create-element": 16,
        "virtual-dom/diff": 17,
        "virtual-dom/h": 18,
        "virtual-dom/patch": 26
    } ],
    4: [ function(require, module, exports) {
        var h = require("virtual-dom/h");
        function render(comm, fhm) {
            return h("div#navWrap.nav", [ h("div.header", [ h("a", {
                href: "#/"
            }, [ h("div.logo", [ h("img", {
                ...
                height: "48",
                width: "48"
            }) ]), h("p.text", [ "Public Health", h("br"), h("small", [ "US Air Force" ]) ]) ]) ]), h("ul", [ h("li", [ h("p.root-cat", [ h("a", {
                href: "#/Comm"
            }, [ "Community Health" ]) ]), h("hr"), h("ul", comm) ]), h("li", [ h("p.root-cat", [ h("a", {
                href: "#/FHM"
            }, [ "Force Health Management" ]) ]), h("hr"), h("ul", fhm) ]) ]) ]);
        }
    ...
    18: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 35
    } ],
    ...
    28: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 37,
        "../vnode/is-vnode.js": 40,
        "../vnode/is-vtext.js": 41,
        "../vnode/is-widget.js": 42,
        "./apply-properties": 27,
        "global/document": 23
    } ],
    ...
    51: [ function(require, module, exports) {
        ...
        function render(style, launch) {
            return h("ul#contentTabs", style, [ h("li.tab", [ h("a", {
                href: "#",
                onclick: function(e) {
