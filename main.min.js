(function e(t, n, r) {
    ...
    3: [ function(require, module, exports) {
        ...
        function render(navDOM) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ h("#contentWrap", [ h("#output"), renderTabs() ]) ]) ]);
        }
        function renderEditor(navDOM, title, text) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ h("#buttons", [ h("#toggleButton.btn", {
                ...
                value: String(title || ""),
                type: "text"
            }) ]), h("textarea#textarea", [ String(text || "") ]) ]), h("#output"), renderTabs() ]) ]) ]);
        }
                    ...
                    for (i = 0; i < count; ++i) {
                        ...
                        if (/^\/fhm\//i.test(page.Category)) {
                            if (!/^\/fhm\/(\w+)$/i.test(page.Category)) {
                                fhmLinks.push(renderLink(page.Category, page.Title, "li.sub-cat", {
                                    style: {
                                        display: "none"
                                    }
                                }, null));
                            } else {
                                fhmLinks.push(renderLink(page.Category, page.Title, "li", null, h("hr")));
                            }
                        }
                        if (/^\/comm\//i.test(page.Category)) {
                            if (!/^\/comm\/(\w+)$/i.test(page.Category)) {
                                commLinks.push(renderLink(page.Category, page.Title, "li.sub-cat", {
                                    style: {
                                        display: "none"
                                    }
                                }, null));
                            } else {
                                commLinks.push(renderLink(page.Category, page.Title, "li", null, h("hr")));
                            }
                        }
