(function e(t, n, r) {
    ...
    2: [ function(require, module, exports) {
        ...
        var regLoading = / ?loading/gi, regFullPage = / ?fullPage/gi, regCheatSheet = / ?cheatSheet/gi, regNoChange = / ?nochange/gi, regNormalize = /[^a-zA-Z0-9_-]/g, md = markdownit({
            xhtmlOut: true,
            typographer: true,
            quotes: "“”‘’",
    ...
    3: [ function(require, module, exports) {
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), misc = require("./helpers"), codeMirror = misc.codeMirror, renderNav = require("./nav"), renderTabs = require("./tabs"), baseURL = _spPageContextInfo.webAbsoluteUrl, sitePath = baseURL + "/_api/lists/getByTitle('Content')", digest = document.getElementById("__REQUESTDIGEST").value, pages = require("./store"), DOMRef = require("./domStore"), current = pages.current, domRefs = new DOMRef(), dirtyDOM = null, rootNode = null, navDOM = null, tabsDOM = renderTabs([ {
            title: "Overview",
            icon: "home"
        } ], {
            style: {
