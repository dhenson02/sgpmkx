(function e(t, n, r) {
    ...
    3: [ function(require, module, exports) {
        ...
        var h = require("virtual-dom/h"), diff = require("virtual-dom/diff"), patch = require("virtual-dom/patch"), createElement = require("virtual-dom/create-element"), uniq = require("lodash.uniq"), reqwest = require("reqwest"), Router = require("director/build/director").Router, console = console || require("console"), sweetAlert = require("sweetalert"), misc = require("./helpers"), Content = require("./store"), DOMRef = require("./domStore"), renderNav = require("./nav"), renderTabs = require("./tabs"), baseURL = _spPageContextInfo.webAbsoluteUrl, sitePath = baseURL + "/_api/lists/getByTitle('Content')", digest = document.getElementById("__REQUESTDIGEST").value, pages = {}, parents = {}, subParents = {}, currentContent = new Content(), domRefs = new DOMRef(), dirtyDOM = null, rootNode = null, navDOM = null, tabsDOM = renderTabs([ "Overview" ], {
            style: {
                display: "none"
            }
        }, handleTab), router = null, inTransition = {}, initialized = false;
        ...
        function getList() {
            reqwest({
                ...
                success: function(data) {
                    var results = data.d.results, urls = [], sections = {}, i = 0, count = results.length, result;
                    for (;i < count; ++i) {
                        result = results[i];
        ...
        function loadPage(path) {
            ...
            reqwest({
                ...
                success: function(data) {
                    ...
                    var tabsStyle = currentContent.program !== "" ? null : {
                        style: {
                            display: "none"
                        }
                    };
                    tabsDOM = renderTabs([ "Overview", "Policy", "Training", "Resources", "Tools", "Contributions" ], tabsStyle, handleTab);
                    resetPage();
        ...
        function render(navDOM, tabsDOM, title) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ tabsDOM, h("h1#ph-title", [ String(title || "") ]), h("#contentWrap", [ h("#output") ]) ]) ]);
        }
        function renderEditor(navDOM, tabsDOM, title, text) {
            return h("#wrapper", [ h("#sideNav", [ navDOM ]), h("#content.fullPage", [ h("#buttons", [ h("button#toggleButton.btn", {
                onclick: toggleEditor,
                style: {
                    display: "none"
                }
            }, [ "Toggle Editor" ]), h("div.clearfix"), h("button#cheatSheetButton.btn", {
                onclick: toggleCheatSheet,
                type: "button"
            }, [ "Cheat Sheet" ]), h("button#saveButton.btn", {
                onclick: savePage,
                type: "button"
            }, [ "Save" ]), h("button#createButton.btn", {
                onclick: createPage,
                type: "button"
            }, [ "New" ]) ]), tabsDOM, h("h1#ph-title", [ String(title || "") ]), h("label#titleFieldLabel", [ "Page title: ", h("input#titleField", {
                onkeyup: updateTitle,
                value: String(title || ""),
                type: "text"
            }) ]), h("#cheatSheet", {
            ...
            }, [ "This will be a cheat-sheet for markdown" ]), h("#contentWrap", [ h("#input", [ h("textarea#textarea", [ String(text || "") ]) ]), h("#output") ]) ]) ]);
        }
        ...
        function pageSetup() {
            dirtyDOM = !codeMirror ? render(navDOM, tabsDOM, currentContent.title) : renderEditor(navDOM, tabsDOM, currentContent.title, currentContent.text);
        ...
        function resetPage() {
            ...
            var oldActive = rootNode.querySelectorAll("a.active"), i = 0, total = oldActive.length;
            for (;i < total; ++i) {
        ...
        reqwest: 31,
        sweetalert: 32,
        "virtual-dom/create-element": 33,
        "virtual-dom/diff": 34,
        "virtual-dom/h": 35,
        "virtual-dom/patch": 43
    } ],
    4: [ function(require, module, exports) {
        var h = require("virtual-dom/h");
        var sweetAlert = require("sweetalert");
        function renderLink(link) {
            return h(link.li, link.attr, [ h("a", {
                href: link.path,
            ...
            }, [ String(link.title), h("span") ]), link.hr ]);
        }
        function renderSection(section) {
            ...
            return h("li", [ h("p.ph-section-link", [ h("a", {
                href: section.path
        ...
        function renderNav(sections) {
            ...
            return h("#ph-nav", [ h(".header", [ h("a", {
                ...
                height: "64",
                width: "64"
            }) ]), h("p.text", [ "Public Health", h("br"), h("small", [ "US Air Force" ]) ]) ]) ]), h("ul.nav", links) ]);
        }
    ...
    14: [ function(require, module, exports) {
        var baseCallback = require("lodash._basecallback"), baseUniq = require("lodash._baseuniq"), isIterateeCall = require("lodash._isiterateecall");
        ...
        "lodash._basecallback": 15,
        "lodash._baseuniq": 24,
        "lodash._isiterateecall": 29
    } ],
    15: [ function(require, module, exports) {
        ...
        "lodash._baseisequal": 16,
        "lodash._bindcallback": 20,
        "lodash.isarray": 30,
        "lodash.pairs": 21
    } ],
    ...
    18: [ function(require, module, exports) {
        ...
        "lodash._getnative": 28,
        "lodash.isarguments": 19,
        "lodash.isarray": 30
    } ],
    ...
    24: [ function(require, module, exports) {
        var baseIndexOf = require("lodash._baseindexof"), cacheIndexOf = require("lodash._cacheindexof"), createCache = require("lodash._createcache");
        ...
        "lodash._baseindexof": 25,
        "lodash._cacheindexof": 26,
        "lodash._createcache": 27
    } ],
    ...
    35: [ function(require, module, exports) {
        ...
        "./virtual-hyperscript/index.js": 52
    } ],
    ...
    45: [ function(require, module, exports) {
        ...
        "../vnode/handle-thunk.js": 54,
        "../vnode/is-vnode.js": 57,
        "../vnode/is-vtext.js": 58,
        "../vnode/is-widget.js": 59,
        "./apply-properties": 44,
        "global/document": 40
    } ],
    ...
    67: [ function(require, module, exports) {
        ...
        function renderTab(title, handleClick, initialTab) {
            return h("li" + initialTab, [ h("a.icon.icon-" + title.toLowerCase(), {
                href: "#",
                onclick: function(e) {
                    e = e || window.event;
